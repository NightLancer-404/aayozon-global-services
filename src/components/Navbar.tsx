      ...
      <div className="bg-primary font-body text-primary-foreground">
        <div className="container-main flex items-center justify-between px-4 py-2 text-sm">
          <div className="flex items-center gap-4">
            <a href="tel:+919999999999" className="flex items-center gap-1 transition-opacity hover:opacity-80">
              <Phone className="h-3 w-3" /> +91 99999 99999
            </a>
            <span className="hidden md:inline">|</span>
            <a href="mailto:info@aayozon.com" className="hidden transition-opacity hover:opacity-80 md:inline">info@aayozon.com</a>
          </div>
          <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 transition-opacity hover:opacity-80">
